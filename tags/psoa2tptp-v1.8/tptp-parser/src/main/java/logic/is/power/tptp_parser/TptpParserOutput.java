...
public interface TptpParserOutput {
    ...
    /** Encapsulates a check for admissibility of a &#60status value&#62
     *  (see the BNF grammar).
     */
    public static class StatusValueCheck {
	
	public static boolean isAdmissible(String str) {
	    return _allAdmissibleValues.contains(str);
	}
	    
	private static final HashSet<String> _allAdmissibleValues;

	static
	{
	    _allAdmissibleValues = new HashSet<String>();
	    _allAdmissibleValues.add("suc");
	    _allAdmissibleValues.add("unp");
	    _allAdmissibleValues.add("sap");
	    _allAdmissibleValues.add("esa");
	    _allAdmissibleValues.add("sat");
	    _allAdmissibleValues.add("fsa");
	    _allAdmissibleValues.add("thm");
	    _allAdmissibleValues.add("eqv");
	    _allAdmissibleValues.add("tac");
	    _allAdmissibleValues.add("wec");
	    _allAdmissibleValues.add("eth");
	    _allAdmissibleValues.add("tau");
	    _allAdmissibleValues.add("wtc");
	    _allAdmissibleValues.add("wth");
	    _allAdmissibleValues.add("cax");
	    _allAdmissibleValues.add("sca");
	    _allAdmissibleValues.add("tca");
	    _allAdmissibleValues.add("wca");
	    _allAdmissibleValues.add("cup");
	    _allAdmissibleValues.add("csp");
	    _allAdmissibleValues.add("ecs");
	    _allAdmissibleValues.add("csa");
	    _allAdmissibleValues.add("cth");
	    _allAdmissibleValues.add("ceq");
	    _allAdmissibleValues.add("unc");
	    _allAdmissibleValues.add("wcc");
	    _allAdmissibleValues.add("ect");
	    _allAdmissibleValues.add("fun");
	    _allAdmissibleValues.add("uns");
	    _allAdmissibleValues.add("wuc");
	    _allAdmissibleValues.add("wct");
	    _allAdmissibleValues.add("scc");
	    _allAdmissibleValues.add("uca");
	    _allAdmissibleValues.add("noc");
	    
	}; // static
	    


    }; // class StatusValueCheck
    ...
    */
     ...
     *  @param statusValue != null, must satisfy 
     *         <code>StatusValueCheck.isAdmissible(statusValue)</code>
     */
    public InfoItem createInferenceStatusInfoItem(String statusValue);
