  ...
  */
  ...
  {  
    ...
    public static class InferenceStatus extends InfoItem {
      ...
      public 
      InferenceStatus(String statusValue) {
        _kind = Kind.InferenceStatus;
        _statusValue = statusValue;
	assert TptpParserOutput.StatusValueCheck.isAdmissible(_statusValue);
      }
  ...
  implements TptpParserOutput.GeneralTerm
  {
    ...
    public boolean isFormula() { return _kind == GeneralTermKind.Formula; }
  ...
  public 
  TptpParserOutput.InfoItem 
  createInferenceStatusInfoItem(String statusValue)
  {
  ...
  public 
  TptpParserOutput.GeneralTerm 
  createGeneralFormula(FofFormula formula)
  {
