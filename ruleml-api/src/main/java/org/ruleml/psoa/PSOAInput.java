...
import org.ruleml.psoa.parser.PSOAPSLexer;
...
public abstract class PSOAInput<T extends PSOAInput<T>> {
	...
	abstract protected ParserRuleReturnScope parse(PSOAPSParser parser) throws RecognitionException;
	...
	abstract public T transform(String name, ANTLRTreeStreamConsumer actor, boolean newKBInst);
